...
<div class="container mx-auto p-8">
    ...
    @endcan
		...
		<div class="w-full md:w-1/3 relative">
			<input type="text" name="searchProgramKeyword" placeholder="제목 검색..." class="w-full pl-10 pr-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
...
<script>
	document.addEventListener('DOMContentLoaded', function () {
		const searchInput = document.querySelector('input[name="searchProgramKeyword"]');
		...
		searchInput.addEventListener('input', async function () {
			...
			if (keyword.length > 0) {
				try {
					const url = `{{ route('admin.program.search') }}?keyword=${encodeURIComponent(keyword)}`;
